...
- [[#具体配置][具体配置]]
  ...
  - [[#init-roam2el--roam-v2][init-roam2.el : roam V2]]
  ...
  - [[#init-mode-lineel--mode-line][init-mode-line.el : mode-line]]
  - [[#init-diredel--dired][init-dired.el : dired]]
  - [[#init-lspel--lsp][init-lsp.el : lsp]]
  - [[#init-evil-multiple-cursorel--evil-下的多行操作][init-evil-multiple-cursor.el : evil 下的多行操作]]
  - [[#init-terminalel--terminal][init-terminal.el : terminal]]
  - [[#init-sessionel--session][init-session.el : session]]
  - [[#init-gtdel--gtd-废弃-采用-init-gtd2el][init-gtd.el : gtd. 废弃, 采用 init-gtd2.el]]
  - [[#init-gtd2el--gtd][init-gtd2.el : gtd.]]
  - [[#init-mermaid--使用-mermaid-在-org-mode-里画图表][init-mermaid : 使用 mermaid 在 org-mode 里画图表]]
- [[#tips-and-tricks][tips and tricks]]
  ...
  - [[#计算执行时间-来自emacs-社区-nasy学姐][计算执行时间 (来自emacs 社区 @nasy学姐)]]
:END:
* introduce
